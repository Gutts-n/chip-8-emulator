...
fn process_instructions(memory: SharedMemory, display: &mut Display) {
    ...
    while true {
        ...
        match instruction & 0xF000 {
            ...
            DRAW => {
                let register_index_for_y = ((instruction & 0x0F00) >> 8) as usize;
                let register_index_for_x = ((instruction & 0x00F0) >> 4) as usize;
                ...
                // display.draw(x, y, number_of_bytes_to_present);
            }
